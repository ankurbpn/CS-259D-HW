...
def get_F1_score():
	...
	dic = get_feature_dict()
	##Select features from scenario 1, 2, 3, 4 or leave the current setting to choose all features
	##feat = select_feature_2()
	feat = range(30)
	##Add last 2 features (uncomment next line to add the new features)
	#feat.extend((30, 31))
	print user_set
	F1 = []
	for u in user_set:
